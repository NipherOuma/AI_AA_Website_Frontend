        ...
        <div class="col-md-6 mb-4 mb-md-0">
          ...
          <form @submit="submitForm">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control border-secondary shadow-sm" id="name" v-model="name" placeholder="Your Name" required>
            </div>
            <div class="mb-3">
              <label for="email" class="form-label">Email address</label>
              <input type="email" class="form-control border-secondary shadow-sm" id="email" v-model="email" placeholder="Your Email" required>
            </div>
            <div class="mb-3">
              <label for="message" class="form-label">Message</label>
              <textarea class="form-control border-secondary shadow-sm" id="message" v-model="message" rows="4" placeholder="Your Message" required></textarea>
            </div>
